...
static void ShowMapNamePopUpWindow(void)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_NORMAL, withoutPrefixPtr, 80);
    mapDisplayHeader[0] = EXT_CTRL_CODE_BEGIN;
    mapDisplayHeader[1] = EXT_CTRL_CODE_HIGHLIGHT;
    mapDisplayHeader[2] = TEXT_COLOR_TRANSPARENT;
    AddTextPrinterParameterized(GetMapNamePopUpWindowId(), FONT_NORMAL, mapDisplayHeader, x, 3, TEXT_SKIP_DRAW, NULL);
