...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_ACETRAINER_M, FACILITY_CLASS_ACETRAINER_M},
    {RS_FACILITY_CLASS_ACETRAINER_F, FACILITY_CLASS_ACETRAINER_F},
...
static const u8 *const sPartnerTextsAceTrainerM[] =
{
    PARTNER_TEXTS(AceTrainerM)
};

static const u8 *const sPartnerTextsAceTrainerF[] =
{
    PARTNER_TEXTS(AceTrainerF)
};
...
} static const sPartnerTrainerTextTables[] =
{
    ...
    {FACILITY_CLASS_ACETRAINER_M,         sPartnerTextsAceTrainerM},
    {FACILITY_CLASS_ACETRAINER_F,         sPartnerTextsAceTrainerF},
