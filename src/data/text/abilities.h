...
static const u8 sSandVeilDescription[] = _("Boosts evasion in a sandstorm.");
...
static const u8 sGutsDescription[] = _("Boosts Attack if suffering.");
static const u8 sMarvelScaleDescription[] = _("Boosts Defense if suffering.");
static const u8 sLiquidOozeDescription[] = _("Draining causes injury.");
static const u8 sOvergrowDescription[] = _("Powers up Grass moves.");
static const u8 sBlazeDescription[] = _("Powers up Fire moves.");
static const u8 sTorrentDescription[] = _("Powers up Water moves.");
static const u8 sSwarmDescription[] = _("Powers up Bug moves.");
