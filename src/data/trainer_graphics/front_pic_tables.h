const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ACETRAINER_M] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_ACETRAINER_F] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ACETRAINER_M, gTrainerFrontPic_AceTrainerM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ACETRAINER_F, gTrainerFrontPic_AceTrainerF, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ACETRAINER_M, gTrainerPalette_AceTrainerM),
    ...
    TRAINER_PAL(ACETRAINER_F, gTrainerPalette_AceTrainerF),
