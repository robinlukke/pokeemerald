...
const u8 gText_Var1CantBeHeld[] = _("{STR_VAR_1} can't be held.");
const u8 gText_Var1CantBeHeldHere[] = _("{STR_VAR_1} can't be held\nhere.");
...
const u8 gText_TMHMContainedVar1[] = _("Select a Pokémon to teach\n{STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MonTypeAndNo[] = _("POKéMON TYPE & NO.");
...
const u8 gText_BattleMon[] = _("BATTLE POKéMON");
...
const u8 gText_EnergyPowder50[] = _("Energy Powder{CLEAR_TO 114}{FONT_NORMAL}50");
const u8 gText_EnergyRoot80[] = _("Energy Root{CLEAR_TO 114}{FONT_NORMAL}80");
const u8 gText_HealPowder50[] = _("Heal Powder{CLEAR_TO 114}{FONT_NORMAL}50");
const u8 gText_RevivalHerb300[] = _("Revival Herb{CLEAR_TO 108}{FONT_NORMAL}300");
const u8 gText_Protein1000[] = _("Protein{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_Iron1000[] = _("Iron{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_Carbos1000[] = _("Carbos{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_Calcium1000[] = _("Calcium{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_Zinc1000[] = _("Zinc{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_HPUp1000[] = _("HP Up{CLEAR_TO 99}{FONT_NORMAL}1,000");
const u8 gText_PPUp3000[] = _("PP Up{CLEAR_TO 99}{FONT_NORMAL}3,000");
...
const u8 gText_Softboiled16BP[] = _("Soft-Boiled{CLEAR_TO 0x4E}16BP");
...
const u8 gText_DisableMusic[] = _("DISABLE MUSIC");
...
const u8 gText_DisableMusicYES[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}YES");
const u8 gText_DisableMusicNO[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO");
...
const u8 gText_CantSelectSamePkmn[] = _("Can't select same Pokémon.");
...
const u8 gText_SamePkmnInPartyAlready[] = _("Same Pokémon in party already.");
...
const u8 gText_WallyMatchCallDesc[] = _("Pokémon Lover");
