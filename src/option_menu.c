...
#define YPOS_DISABLEMUSIC  (MENUITEM_DISABLEMUSIC * 16)
...
static u8 DisableMusic_ProcessInput(u8 selection);
static void DisableMusic_DrawChoices(u8 selection);
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_DISABLEMUSIC] = gText_DisableMusic,
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tDisableMusic = gSaveBlock2Ptr->optionsDisableMusic;
        ...
        DisableMusic_DrawChoices(gTasks[taskId].tDisableMusic);
    ...
    else
    {
        ...
        case MENUITEM_BATTLESCENE:
            ...
            if (previousOption != gTasks[taskId].tBattleSceneOff)
                BattleScene_DrawChoices(gTasks[taskId].tBattleSceneOff);
            break;
        case MENUITEM_DISABLEMUSIC:
            previousOption = gTasks[taskId].tDisableMusic;
            gTasks[taskId].tDisableMusic = DisableMusic_ProcessInput(gTasks[taskId].tDisableMusic);

            if (previousOption != gTasks[taskId].tDisableMusic)
                DisableMusic_DrawChoices(gTasks[taskId].tDisableMusic);
            break;
        case MENUITEM_SOUND:
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsDisableMusic = gTasks[taskId].tDisableMusic;
...
static void DisableMusic_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_DisableMusicYES, 104, YPOS_DISABLEMUSIC, styles[0]);
    DrawOptionMenuChoice(gText_DisableMusicNO, GetStringRightAlignXOffset(FONT_NORMAL, gText_DisableMusicNO, 198), YPOS_DISABLEMUSIC, styles[1]);
}
